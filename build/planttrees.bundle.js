...
/***/ function(module, exports, __webpack_require__) {
	...
	var stageController = __webpack_require__(21),
	    util = __webpack_require__(13);

	var TweenLite = __webpack_require__(22);

	var trunkMaxLength = 180,
	    trunkMinLength = 140,
	    trunkMaxBrance = 9,
	    trunkMinBrance = 6;
	...
	var resizeFn = function resizeFn(width, height) {
	    canvas.width = width;
	...
	var drawTreeFrame = function drawTreeFrame() {
	    if (!tree) {
	        return;
	    }
	...
	var generatTree = function generatTree(x, y) {
	    var trunkLength = (0, _util.randomFloat)(trunkMinLength, trunkMaxLength),
	    ...
	    tree = new _tree2.default(x, y, trunkLength, -90, color, depth, isDay);
	};

	var planttrees = new Vue({
	    el: '#app',
	    replace: false,
	    template: '<div class="planttrees contents-data">' + '<div id="planttrees--bg"></div>' + '<canvas class="planttrees--canvas"></canvas>' + '<div class="planttrees--bt"></div>' + '<div id="planttrees-guide" class="contents-guide">' + '<div class="guide-tooltip">press</div>' + '<div class="guide-mouse"></div>' + '</div>' + '</div>',
	    ...
	    methods: {
	        ...
	        setup: function setup($container) {
	            ...
	            canvas = $container.find('.planttrees--canvas').get()[0], $bt = $container.find(".planttrees--bt"), $bg = $container.find('.planttrees--bg');
			...
			this.check = function (init) {
				...
				if (missing === 0 && func) {
					...
					if (global) {
						...
						if (!hasModule && "function" === "function" && __webpack_require__(23)) {
							//AMD
							!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
								return cl;
							}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Point = function () {
	    ...
	    _createClass(Point, [{
	        ...
	        key: 'subtract',
	        value: function subtract(target) {
	        ...
	        key: 'normalize',
	        value: function normalize(speed) {
	        ...
	        key: 'add',
	        value: function add(point, target) {
	            return new Point(point.x + target.x, point.y + target.y);
	        }
	    }, {
	        key: 'subtract',
	        value: function subtract(point, target) {
	            return new Point(point.x - target.x, point.y - target.y);
	        }
	    }, {
	        key: 'interpolate',
	        value: function interpolate(start, end, n) {
	            var bx = end.x - start.x,
	                by = end.y - start.y;
	            return new Point(start.x + bx * n, start.y + by * n);
	        }
	    }]);
	...
	var Brance = function () {
	    function Brance(startX, startY) {
	        var length = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];
	        var angle = arguments.length <= 3 || arguments[3] === undefined ? -90 : arguments[3];
	        var speed = arguments.length <= 4 || arguments[4] === undefined ? 3 : arguments[4];
	        var depth = arguments.length <= 5 || arguments[5] === undefined ? 1 : arguments[5];
	        var generation = arguments.length <= 6 || arguments[6] === undefined ? 1 : arguments[6];

	        _classCallCheck(this, Brance);
	        ...
	        var angleOffset = this._angle * angleUnit;

	        this._end = new Point(this._start.x + this._length * Math.cos(angleOffset), this._start.y + this._length * Math.sin(angleOffset));
	    ...
	    _createClass(Brance, [{
	        ...
	        key: 'createNext',
	        value: function createNext(generation) {

	            var depth = Math.max(this._depth - 1, 0);
	            ...
	            for (var i = 0; i < generation; i++) {
	                var min = anglePart * i - angleOffsetRange / 2,
	                    max = min + anglePart;
	                y[i] = (0, _util.randomFloat)(min, max) | 0;
	            }
	            y.sort(function (a, b) {
	            ...
	            var nextBrances = [],
	                ...
	                B = 0.55 / generation;
	            for (var _i = 0; _i < generation; _i++) {
	                var interpolate = _i === 0 ? 0 : (0, _util.randomFloat)(B * _i, B * (_i + 1)),
	                    interpolatePoint = this.interpolate(interpolate),
	                    angle = this._angle + y[_i],
	                    nextLenRatio = 0.3 * Math.abs(Math.cos((angle + 90) * angleUnit)),
	                    length = this._length * (0, _util.randomFloat)(0.25 + nextLenRatio, 0.65 + nextLenRatio);

	                nextBrances[_i] = new Brance(interpolatePoint.x, interpolatePoint.y, length, angle, (0, _util.randomFloat)(3, 5), depth, nextGeneration);
	            }
	            return nextBrances;
	        }
	    }, {
	        ...
	        value: function update() {
	            ...
	            n.lines.push([[latest.x, latest.y], [current.x, current.y]]);
	...
	var TreeClass = function () {
	    function TreeClass(startX, startY, length, angle, color, depth, isDay) {
	        ...
	        this._brances.push(new Brance(startX, startY, length, angle, (0, _util.randomFloat)(3, 6), depth, 1));
	    }
	    ...
	    _createClass(TreeClass, [{
	        ...
	        value: function draw(context) {
	            ...
	            for (var i = 0; i < branceLen; i++) {

	                var brance = brances[i];
	                brance.update();

	                if (brance.complete()) {
	                    brances.splice(i, 1);
	                    i--;
	                    var generation = brance.generation() < 3 ? (0, _util.randomInteger)(3, 4) : (0, _util.randomInteger)(2, 4),
	            ...
	            for (var lineKey in linePaths) {
	                var line = linePaths[lineKey],
	                    linePositions = line.lines;
	                context.beginPath();
	                context.lineWidth = line.lineWidth;
	                for (var _i2 = 0, max = linePositions.length; _i2 < max; _i2++) {
	                    var linePosition = linePositions[_i2];
	        ...
	        key: 'generatTree',
	        value: function generatTree(x, y) {
	            var trunkLength = (0, _util.randomFloat)(trunkMinLength, trunkMaxLength),
	                T = trunkLength - trunkMinLength,
	                R = (trunkMaxLength - trunkMinLength) / (trunkMaxBrance - trunkMinBrance),
	                depth = trunkMinBrance + (0.5 + T / R | 0),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers:[\">1%\"]}!./main.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./../../../node_modules/autoprefixer-loader/index.js?{browsers:[\">1%\"]}!./main.scss");
