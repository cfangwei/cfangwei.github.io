	    ...
	    _createClass(Brance, [{
	        ...
	        value: function createNext(generation) {
	            ...
	            var nextBrances = [],
	                ...
	                B = 0.55 / generation;
	            for (var i = 0; i < generation; i++) {
	                var interpolate = i === 0 ? 0 : (0, _util.randomFloat)(B * i, B * (i + 1)),
	                ...
	                nextBrances[i] = new Brance(interpolatePoint.x, interpolatePoint.y, length, angle, (0, _util.randomFloat)(3, 5), depth, nextGeneration);
	            }
	            return nextBrances;
	        }
	    }, {
	    ...
	    _createClass(TreeClass, [{
	        ...
	        value: function draw(context) {
	            ...
	            for (var lineKey in linePaths) {
	                ...
	                for (var i = 0, max = linePositions.length; i < max; i++) {
