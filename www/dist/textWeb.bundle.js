...
/***/ function(module, exports, __webpack_require__) {
	...
	var _charworld = __webpack_require__(80);

	var _char = __webpack_require__(81);
	...
	var charWorld = new _charworld.CharWorld(canvas, 50);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CharWorld = exports.CharWorld = function () {
	    function CharWorld(canvas, charN) {
	        var _this = this;

	        _classCallCheck(this, CharWorld);
	        ...
	        this.chars = [];
	        _.times(charN, function () {
	            _this.chars.push(new _char.Char((0, _string.charRandom)(), _this.canvas.width, _this.canvas.height, 16));
	        });

	        this.bindEvent();
	    }

	    _createClass(CharWorld, [{
	        key: 'bindEvent',
	        ...
	        value: function render() {
	            ...
	            this.chars.map(function (char) {
	                char.update(_this3.ctx, _this3.mouseX, _this3.mouseY);
	            });
	        }
	    }, {
	        key: 'tick',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Char = exports.Char = function () {
	    function Char(char, ww, wh, size) {
	        var reactDis = arguments.length <= 4 || arguments[4] === undefined ? 150 : arguments[4];
	        ...
	        this.colorBase = (0, _util.randomInteger)(0, 15);
	    ...
	    _createClass(Char, [{
	        key: 'reset',
	        value: function reset(worldWidth, worldHeight) {
	            this.ww = worldWidth;
	            this.wh = worldHeight;
	        }
	    }, {
	        ...
	        key: 'update',
	        value: function update(ctx, mx, my) {
	            this.move(mx, my);
	            this.render(ctx);
	        }
	    }]);
