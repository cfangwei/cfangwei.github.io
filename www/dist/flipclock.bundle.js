...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log((0, _detector.cssHead)());
	...
	var FlipClock = FlipClock || function () {
	    ...
	    function resizeFn() {
	        ...
	        n[0].style[(0, _detector.cssHead)()] = 'scale(' + w + ')';
	    }
	    function dispose() {
	    ...
	    function flipSec(sec) {
	        n.removeClass('play');
	        var activeLi = $('ul.flip-second li.active');
	        ...
	        var nextSec = (0, _util.addZeros)(sec, 1);
	        var w = $('ul.flip-second li').eq(r + 1);
