...
/***/ function(module, exports, __webpack_require__) {
	...
	var _treeRiver = __webpack_require__(71);

	var treeRiver = new _treeRiver.TreeRiver({});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ARROW = __webpack_require__(76);

	var TreeRiver = exports.TreeRiver = function () {
	    function TreeRiver(params) {
	        _classCallCheck(this, TreeRiver);
	    ...
	    _createClass(TreeRiver, [{
	        ...
	        value: function grow() {
	            ...
	            this.viewport = new _viewport.Viewport(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.bezierString = bezierString;
	...
	function createElement(nodeType, attr) {
	...
	function setClass(elem, className) {
	    if (elem.getAttribute('class') !== className) elem.setAttribute('class', className);
	}
	...
	function bezierString(x1, y1, cx1, cy1, cx2, cy2, x2, y2) {
	    return 'M' + x1.toFixed(10) + ',' + y1.toFixed(10) + ' C' + cx1.toFixed(10) + ',' + cy1.toFixed(10) + ' ' + cx2.toFixed(10) + ',' + cy2.toFixed(10) + ' ' + x2.toFixed(10) + ' ' + y2.toFixed(10);
	}
	...
	function transformString(commands) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _math = __webpack_require__(75);
	...
	var Viewport = exports.Viewport = function () {
	    ...
	    _createClass(Viewport, [{
	        key: 'set',
	        value: function set(x, y, rotation, scale) {
	            ...
	            this.contains = Math.abs(rotation % math.TWO_PI) > this.rotationTolerance ? this.containsWhileRotated : this.containsWhileStraight;
	        ...
	        value: function calculateRotatedPosition(obj) {
	        ...
	        key: 'containsWhileRotated',
	        value: function containsWhileRotated(obj) {
	            return this.xr + obj.x1r >= this.x1r && this.xr + obj.x2r <= this.x3r && this.yr + obj.y1r >= this.y1r && this.yr + obj.y2r <= this.y3r;
	        }
	    }, {
	        key: 'containsWhileStraight',
	        value: function containsWhileStraight(obj) {
	            return obj.x1 >= this.x1 && obj.x2 <= this.x3 && obj.y1 >= this.y1 && obj.y2 <= this.y3;
	        }
	    }, {
	        key: 'updateWidthAndHeight',
	        value: function updateWidthAndHeight() {
...
/***/ function(module, exports) {
	...
	var bezier = function bezier(a, b, c, d, t) {
	    // seems like a hack:
	    if (a === b && c === d) {
	        return undefined.lerp(a, d, t);
	    }
	    var t1 = 1.0 - t;
	    return a * t1 * t1 * t1 + 3 * b * t * t1 * t1 + 3 * c * t * t * t1 + d * t * t * t;
	};

	var bezierTangent = function bezierTangent(a, b, c, d, t) {
	    return 3 * t * t * (-a + 3 * b - 3 * c + d) + 6 * t * (a - 2 * b + c) + 3 * (-a + b);
	};

	var bezierHandle = function bezierHandle(a, b, c, d, t) {
	    // seems like a hack:
	    if (a == b && c == d) {
	        return [a, undefined.lerp(d, a, t)];
	    }
	    var n = undefined.lerp(b, a, t);
	    var m = undefined.lerp(c, b, t);
	    return [n, undefined.lerp(m, n, t)];
	};

	var pivotX = function pivotX(x, y, angle) {
	...
	var pivotY = function pivotY(x, y, angle) {
	...
	exports.bezierHandle = bezierHandle;
...
/***/ function(module, exports) {
	...
	module.exports = "M0,0.522c0-0.032,0.008-0.059,0.024-0.08S0.061,0.41,0.087,0.41h0.494L0.369,0.193C0.354,0.178,0.347,0.159,0.347,0.137\n\tc0-0.033,0.014-0.064,0.042-0.093C0.417,0.015,0.446,0,0.479,0c0.02,0,0.039,0.007,0.057,0.022l0.428,0.432\n\tC0.988,0.482,1,0.505,1,0.522c0,0.018-0.012,0.039-0.037,0.062L0.535,1.011C0.521,1.025,0.501,1.032,0.479,1.032\n\tc-0.032,0-0.062-0.014-0.09-0.042c-0.027-0.028-0.042-0.059-0.042-0.09c0-0.022,0.007-0.04,0.022-0.055l0.212-0.212H0.087\n\n"
